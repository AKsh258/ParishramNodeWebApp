...
const Employee = element.define("Employee", {
    ...
    EmpID: { type: DataTypes.INTEGER,primaryKey: true,  allowNull: false },
    ...
    FatherName: { type: DataTypes.STRING(150), allowNull: true  },
    MotherName: { type: DataTypes.STRING(150), allowNull: true  },
